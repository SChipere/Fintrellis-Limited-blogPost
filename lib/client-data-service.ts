...
export async function checkParseConnection(): Promise<boolean> {
  ...
  try {
    ...
    console.error("Error checking Parse connection:", error)
    useLocalStorageFallback = true
    return false
  }
}
...
export function getStorageMode() {
  return {
    usingLocalStorage: useLocalStorageFallback,
    storageType: useLocalStorageFallback ? "Local Storage" : "Back4App",
  }
}
